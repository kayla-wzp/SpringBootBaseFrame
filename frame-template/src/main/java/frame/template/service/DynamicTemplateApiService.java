...
public class DynamicTemplateApiService {
    ...
    public String getHtmlViewStr(InputStream inputStream, String businessId, String templateId,
        ...
        cffs.core.service.dynamictemplate.DynamicTemplateFactory dynamicTemplateFactory = BeanFactory.getBean(cffs.core.service.dynamictemplate.DynamicTemplateFactory.class);
    ...
    public InputStream generateContract(InputStream inputStream, String businessId, String templateId,
        ...
        InputStream newInputStream =
                dynamicTemplateFactory.getTemplateInputStream(templateId, businessId, enterParamMap, inputStream);
